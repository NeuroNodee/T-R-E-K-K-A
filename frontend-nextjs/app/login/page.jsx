...
const Login = () => {
    ...
    try {
      if (isLogin) {
        ...
        if (data.success) {
          ...
          setStep("verify-otp"); // move to OTP input
        } else {
  ...
  return (
    <>
      {loading && (isLogin ? <Loading text={"Logging In..."} /> : <Loading text={"Signing Up..."} />)}
      <div className={`${isLogin ? "login" : "signup"}`}>
        <div className="section1">
          ...
          <div className={`${isLogin ? "login-content" : "signup-content"}`}>
            ...
            <div className={step != "signup" ? "hide" : "social-icon"}>
            ...
            <span className={step != "signup" ? "hide" : "login-faint"}>----------------or continue with----------------</span>
            ...
            {step === "signup" ? (
              ...
              <div className="form-otp">
                <h3>Enter OTP sent to <span>{emailForOtp}</span></h3>
                <input
                  type="text"
                  value={otp}
